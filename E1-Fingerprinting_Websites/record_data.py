...
parser.add_argument("--attacker_type", type=str, choices=["javascript", "javascript_cache", "counter", "ebpf","tick"], default="tick")
...
def get_driver(browser):
    ...
    if browser == Browser.SAFARI:
        ...
        #print(opts.tor_browser_path)
        return TorBrowserDriver(executable_path="/home/xin/geckodriver",tbb_path=opts.tor_browser_path,default_bridge_type='meek_lite')
...
def collect_data(q):
    ...
    if opts.attacker_type == "tick":
        ...
        while True:
            count_full = cdll.LoadLibrary('/home/xin/tick-count' + '/tick.so') # Need to be modified
...
def run(domain, update_fn=None):
    out_f_path = os.path.join(opts.out_directory, f"{domain.replace('https://', '').replace('http://', '').replace('www.', '')}.pkl")
    out_f_path='/home/xin/tick-count/'+out_f_path
